...
describe('Cart Store', () => {
  ...
  it('should add 1 as initial quantity  when add a new product', function () {
  ...
  it('should increase the quantity when + is clicked', function () {
    const product = server.create('product');
    act(() => {
      add(product);
      increase(product);
  ...
  it('should decrease the quantity when - is clicked', function () {
    const product = server.create('product');
    act(() => {
      add(product);
      decrease(product);
  ...
  it('should not decrease bellow zero', function () {
    const product = server.create('product');
    act(() => {
      add(product);
      decrease(product);
